...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Wx691211".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["61.144.161.114"];
pub const RS_PUB_KEY: &str = "y2d2lmMYz+lRDNzL11xhECzlfVYomteQPzbMhbGV0tk=";
